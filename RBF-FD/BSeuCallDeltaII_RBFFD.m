function [Delta]=BSeuCallDeltaII_RBFFD(S,K,T,r,sig)
%% 1D European Call RBF-FD-GA
...
for ii=2:m
    ...
    wc2=rbfga_weights_BS('x',ep,xi,xc,r,sig); wd=wc2;
    wc2=wc2*r*x(ii);
...
delta = D*u;
Delta = interp1(x,delta,S/K,'spline');
end